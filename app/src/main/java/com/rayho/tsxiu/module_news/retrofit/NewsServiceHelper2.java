 ...
 */
public class NewsServiceHelper2 {
    //连接请求超时的时间s
...
/*        builder.addInterceptor(new CacheIntercepter());
    ...
    private static class SingleHolder{
        public static NewsServiceHelper2 instance = new NewsServiceHelper2();
    }

    public static NewsServiceHelper2 getInstance(){
