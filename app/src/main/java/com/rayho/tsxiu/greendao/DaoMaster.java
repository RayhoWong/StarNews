...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        NewsCacheDao.createTable(db, ifNotExists);
        SearchHistoryDao.createTable(db, ifNotExists);
        ImageDao.createTable(db, ifNotExists);
        VideoAutoPlayDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        NewsCacheDao.dropTable(db, ifExists);
        SearchHistoryDao.dropTable(db, ifExists);
        ImageDao.dropTable(db, ifExists);
        VideoAutoPlayDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(VideoAutoPlayDao.class);
    }
